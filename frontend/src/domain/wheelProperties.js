...
// UI column presentation is composed separately in the comparator UI adapter.
//
// To add a new wheel property (filter + sort + accessor), add an entry to
// WHEEL_PROPERTIES. Add a UI override only when the generic renderer is not
// sufficient.

import { resolveSpec } from './wheelUtils';
import { convert, isSupportedCurrency } from './currency';
