...
const DIMENSIONS = [
  { key: 'externalWidth', x: 330, y: 0 },
  { key: 'internalWidth', x: 330, y: 45 },
...
const BenefitsSchematic = ({ t }) => (
  <figure className="schematic-card">
    <div className="schematic-layout">
      <svg viewBox="0 -25 420 335" fill="none" aria-hidden="true" focusable="false">
        ...
        <g className="rim-dimensions">
          <path className="dimension-extension" d="M83 59V-5M259 59V-5" /><path className="dimension-measure" d="M83 0h176" /><path className="dimension-arrow" d="m91 -4-8 4 8 4M251 -4l8 4-8 4" /><path className="dimension-route" d="M259 0h53" />
          <path className="dimension-extension" d="M97 59V40M245 59V40" /><path className="dimension-measure" d="M97 45h148" /><path className="dimension-arrow" d="m105 41-8 4 8 4M237 41l8 4-8 4" /><path className="dimension-route" d="M245 45h67" />
