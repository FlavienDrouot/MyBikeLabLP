...
const DIMENSIONS = ['externalWidth', 'internalWidth', 'rimDepth', 'wheelDiameter'];

const BenefitsSchematic = ({ t }) => (
  <figure className="schematic-card">
    <div className="schematic-layout">
      <svg viewBox="0 0 420 350" fill="none" aria-hidden="true" focusable="false">
        ...
        <g className="rim-dimensions">
          <path className="dimension-extension" d="M83 59V15M259 59V15" /><path className="dimension-measure" d="M83 20h176" /><path className="dimension-arrow" d="m91 16-8 4 8 4M251 16l8 4-8 4" /><path className="dimension-route" d="M259 20h101v50h12" />
          <path className="dimension-extension" d="M97 59V40M245 59V40" /><path className="dimension-measure" d="M97 45h148" /><path className="dimension-arrow" d="m105 41-8 4 8 4M237 41l8 4-8 4" /><path className="dimension-route" d="M245 45h95v95h32" />
          <path className="dimension-extension" d="M259 59h31M171 290h119" /><path className="dimension-measure" d="M285 59v231" /><path className="dimension-arrow" d="m281 67 4-8 4 8M281 282l4 8 4-8" /><path className="dimension-route" d="M285 174h95v36" />
          <circle className="dimension-point" cx="91" cy="195" r="3" /><path className="dimension-route" d="M91 195H24v125h336v-40h12" />
        </g>
        <g className="schematic-markers">
          {DIMENSIONS.map((key, index) => (
            <g key={key} transform={`translate(390 ${70 + index * 70})`}>
              <circle r="18" />
